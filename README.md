...
本项目在开发过程中使用了多种来源的图片、视频及数据资源。特此说明如下：

- **3D地球纹理**: 来源于NASA公开纹理库。
- **部分地区介绍图片**: 来源于百度百科及视觉中国。
- **文物介绍图片**: 来源于中国国家博物馆数字展厅。
- **地区视频介绍**: 来源于哔哩哔哩视频及中国网公开视频。
- **数据处理与整合**: 收集到的数据通过开源模型DeepSeek进行整理整合为对应格式，并通过Gemini进行联网数据校对。
- **版权声明**: 本项目所使用的所有图片及视频仅用于学习和展示目的，不用于商业用途。如有任何内容侵犯了您的版权，请及时联系仓库所有者进行删除处理。

## 许可证

本项目为比赛作品，采用专有许可证。

© 2025 《丝路千年经纬：前1911欧亚文明交互可视化系统》团队。保留所有权利。

允许私下访问和使用本项目，但严禁将本项目公开用于其他竞赛以及商业项目。如发现未经授权的公开使用行为，项目团队保留追究法律责任的权利。
